  ...
  return (
    <div className="bg-gray-50/50 min-h-screen pb-16 font-sans antialiased" id="how-it-works-page">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 space-y-24">
        ...
        <section className="bg-white rounded-3xl border border-gray-150 p-8 sm:p-12 shadow-sm space-y-10" id="documents-required-section">
        ...
        <section className="bg-slate-950 text-white rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-xl border border-slate-850" id="eligibility-checklist-section">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8 space-y-4.5">
        ...
        <section className="bg-white rounded-3xl border border-gray-150 p-8 sm:p-10 shadow-sm space-y-8 animate-fade-in" id="timeline-faqs">
          <div className="text-center max-w-2xl mx-auto space-y-2">
        ...
        <section className="bg-[#111A2E] text-white rounded-3xl p-8 sm:p-14 relative overflow-hidden text-center space-y-6" id="process-page-cta">
