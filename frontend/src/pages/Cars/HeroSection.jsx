...
export function HeroSection({ scrollToTarget }) {
  return (
    <section className="relative h-[550px] bg-slate-950 text-white flex items-center overflow-hidden" id="explore-hero-banner">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full text-center space-y-6">
        ...
        <p className="text-sm sm:text-base text-slate-355 text-slate-300 max-w-2xl mx-auto leading-relaxed">
          Find the perfect rent-to-buy vehicle that fits your lifestyle and budget. Pay predictable weekly contributions with no penalizing credit limits.
        </p>
